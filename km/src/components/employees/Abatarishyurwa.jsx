        ...
        <div>
              <div className="flex text-sm">
                ...
                <div className='absolute right-0 mr-8 flex'>
                    <div className='border-2 mr-10 rounded-md  hover:bg-side border-def border-solid'>
              ...
              <div className='' >
                  <div className='flex mt-6 mb-2'>
                      <Link to="/abakozi">
                      <p className=' cursor-pointer hover:underline hover:text-def '>Abakozi</p>
                      </Link>
                      <Link to="/abakozi/abatagikora">
                      <p className=' cursor-pointer ml-6 hover:underline hover:text-def '>Abatagikora</p>
                      </Link>
                      <Link to="/abakozi/abatarishyurwa">
                      <p className=' cursor-pointer ml-6  text-def  font-bold '>Abatarishyurwa</p>
                      </Link>
