...
<div className=' text-sm bg-box py-10 px-10 cnt2  w-2/5 mt-52  '>
 ...
 <div>
    <p>Amazina yombi</p>
    <input spellCheck="false" className=' px-2 py-1   mt-1 focus:outline-none border rounded-md w-9/12 ' type="text" />
    </div>
 <div className='mt-2'>
    <p>Tel no</p>
    <input spellCheck="false" className=' px-2 py-1   mt-1 focus:outline-none border rounded-md w-9/12 ' type="text" />
...
<div className='mt-4'>
    <button className='bg-def text-white text-sm w-9/12 rounded-md py-1'>Save</button>
</div>
